function output = generate_binary_decision_dialog(title,string,varargin)
UI = struct(...
    'Margin',30,... %[px]
...
uicontrol(...
    ...
    'FontWeight',inputs.FontWeight,...
    'String', 'Yes',...
    'Callback',@(src,evnt)respond_to_binary_decision(true));
...
uicontrol(...
    ...
    'FontWeight',inputs.FontWeight,...
    'String', 'No',...
    'Callback',@(src,evnt)respond_to_binary_decision(false));

set(UI.hFig,...
    'Visible','on');
uiwait(UI.hFig)

    function respond_to_binary_decision(decision)
        output = decision;
        delete(UI.hFig)
    end %fun
